...
import { requestPart } from "./part-bus";
 ...
 * script, or before the explorer has hydrated, the browser jumps there
 * and opens the details itself, and the part is described in words.
 *
 ...
 * router follows), and the request goes to the explorer (part-bus.ts),
